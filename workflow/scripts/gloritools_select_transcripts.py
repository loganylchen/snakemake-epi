...
with pysam.FastaFile(snakemake.input.transcriptome_reference) as fasta:
    transcripts = fasta.references
...
annotate_df = annotate_df.loc[annotate_df['transcript_id'].isin(list(transcripts))]
